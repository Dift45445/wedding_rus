      ...
      <section id="gifts" className="min-h-screen relative overflow-hidden">
        <div className="container mx-auto px-4 py-20 relative z-10">
          ...
          >
            ...
            >
              {/* Arabic InsyaAllah */}
              <p className="text-lg text-gray-800">Спасибо за вашу поддержку</p>

              {/* Main Message */}
              <p className="text-gray-600 leading-relaxed">
                Если вы хотите поздравить нас материально, вы можете сделать
                перевод на карту ниже.
              </p>

              {/* Arabic Dua */}
              <div className="space-y-2">
                  <p className="text-gray-600 italic text-sm">
                    Спасибо, что разделяете с нами этот день
                  </p>
              </div>
            </motion.div>
