    ...
    <div className="relative">
      ...
      >
        ...
        <div className="space-y-3 text-gray-600">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span>{eventData.startTime?.substring(0, 5) || eventData.startTime} - {eventData.endTime?.substring(0, 5) || eventData.endTime} МСК</span>
          </div>
          <div className="flex items-center space-x-3">
      ...
      >
        <div className="space-y-6 ">
          <div className="flex justify-between  items-center">
            <h3 className="text-xl font-semibold text-gray-800">Добавить в календарь</h3>
            <motion.button
